...
{
	isa->vsx=!!(features&UINT32_C(CPUINFO_POWERPC_LINUX_FEATURE_HAS_VSX));
	//isa.vmx=features&UINT32_C(?);
	isa->htm=!!(features2&UINT32_C(CPUINFO_POWERPC_LINUX_FEATURE_HTM));
	isa->mma=!!(features2&UINT32_C((CPUINFO_POWERPC_LINUX_FEATURE_HAS_MMA));
}
